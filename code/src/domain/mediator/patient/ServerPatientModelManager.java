...
public class ServerPatientModelManager extends UnicastRemoteObject
      implements RemotePatientModel
{
   ...
   public void addPatient(String[] patientData)
   {
      ...
      if (patientData[2] != null)
      {
         ...
         patient = new Patient(id, firstName, lastName, dob, telNumber, email,
               gender);
         try
         {
